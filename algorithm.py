...
class Slot:
    ...
    def to_table_format(self):
        return (
            f"{str(self.time_slot.day).ljust(20)} | "
            f"{str(self.time_slot.time).ljust(20)} | "
            f"{str(self.subject.name).ljust(20)} | "
            f"{str(self.lecturer.name).ljust(20)} | "
            f"{str(self.hall.name).ljust(20)}"
        )
...
class Schedule:
    ...
    # Схрещування для генетичного різноманітя.
...
class ScheduleManager:
    ...
    # Мутація для нових варіантів в популяції, де випадково заповнюємо порожні значення (аудиторії, викладачі, часові слоти) для кожного заняття.
    ...
    # 1. Створюємо початкову популяцію випадкових розкладів.
    def init_random_schedule(self):
        ...
        # Якщо неможливо знайти доступні слоти чи викладачів, починається рекурсивна генерація нового розкладу.
    ...
    # Визначення якості розкладу. Чим менша вартість -> тим більша пристосованість розкладу.
    ...
    # Відбір. Випадково вибираємо к-ть розкладів з поточної популяції. Повертає найкращий (де найбільший fitness - якість розкладу)
    ...
    # Основний цикл еволюції популяцій
